 ...
 *             &lt;choice minOccurs="0">
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}sect2" maxOccurs="unbounded"/>
...
public class Sect1 {
    ...
    @XmlElement(name = "sect2")
    protected List<Sect2> sect2S;
    ...
    /**
     * Gets the value of the sect2S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sect2S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSect2s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Sect2> getSect2s() {
        if (sect2S == null) {
            sect2S = new ArrayList<Sect2>();
        }
        return this.sect2S;
    }
