 ...
 *             &lt;choice minOccurs="0">
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}section" maxOccurs="unbounded"/>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}simplesect" maxOccurs="unbounded" minOccurs="0"/>
 *               &lt;/sequence>
 *               &lt;element ref="{http://docbook.org/ns/docbook}simplesect" maxOccurs="unbounded"/>
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}sect1" maxOccurs="unbounded"/>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}simplesect" maxOccurs="unbounded" minOccurs="0"/>
 *               &lt;/sequence>
...
public class Partintro {
    ...
    @XmlElement(name = "refentry")
    protected List<Refentry> refentries;
    ...
    /**
     * Gets the value of the refentries property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the refentries property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRefentries().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Refentry> getRefentries() {
        if (refentries == null) {
            refentries = new ArrayList<Refentry>();
        }
