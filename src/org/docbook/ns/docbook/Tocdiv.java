 ...
 *           &lt;element ref="{http://docbook.org/ns/docbook}tocdiv"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}tocentry"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    ...
    "tocdivsAndTocentries"
})
@XmlRootElement(name = "tocdiv")
public class Tocdiv {
    ...
    @XmlElements({
        @XmlElement(name = "tocdiv", type = Tocdiv.class),
        @XmlElement(name = "tocentry", type = Tocentry.class)
    })
    protected List<Object> tocdivsAndTocentries;
    ...
    /**
     * Gets the value of the tocdivsAndTocentries property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tocdivsAndTocentries property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTocdivsAndTocentries().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getTocdivsAndTocentries() {
        if (tocdivsAndTocentries == null) {
            tocdivsAndTocentries = new ArrayList<Object>();
        }
        return this.tocdivsAndTocentries;
    }
    ...
    /**
     * Recupera il valore della proprietà pagenum.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Imposta il valore della proprietà pagenum.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
