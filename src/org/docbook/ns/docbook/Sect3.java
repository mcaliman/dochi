 ...
 *             &lt;choice minOccurs="0">
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}sect4" maxOccurs="unbounded"/>
...
public class Sect3 {
    ...
    @XmlElement(name = "sect4")
    protected List<Sect4> sect4S;
    ...
    /**
     * Gets the value of the sect4S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sect4S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSect4s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Sect4> getSect4s() {
        if (sect4S == null) {
            sect4S = new ArrayList<Sect4>();
        }
        return this.sect4S;
    }
