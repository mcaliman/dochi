 ...
 *             &lt;choice minOccurs="0">
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}sect3" maxOccurs="unbounded"/>
...
public class Sect2 {
    ...
    @XmlElement(name = "sect3")
    protected List<Sect3> sect3S;
    ...
    /**
     * Gets the value of the sect3S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sect3S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSect3s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Sect3> getSect3s() {
        if (sect3S == null) {
            sect3S = new ArrayList<Sect3>();
        }
        return this.sect3S;
    }
