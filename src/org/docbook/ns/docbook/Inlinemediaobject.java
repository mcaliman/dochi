 ...
 *         &lt;element ref="{http://docbook.org/ns/docbook}alt" minOccurs="0"/>
 *         &lt;choice maxOccurs="unbounded">
 *           &lt;element ref="{http://docbook.org/ns/docbook}videoobject"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}audioobject"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}imageobject"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}textobject"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}imageobjectco"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "info",
    "alt",
    "videoobjectsAndAudioobjectsAndImageobjects"
})
@XmlRootElement(name = "inlinemediaobject")
public class Inlinemediaobject {

    protected Info info;
    protected Alt alt;
    @XmlElements({
        @XmlElement(name = "videoobject", type = Videoobject.class),
        @XmlElement(name = "audioobject", type = Audioobject.class),
        @XmlElement(name = "imageobject", type = Imageobject.class),
        @XmlElement(name = "textobject", type = Textobject.class),
        @XmlElement(name = "imageobjectco", type = Imageobjectco.class)
    })
    protected List<Object> videoobjectsAndAudioobjectsAndImageobjects;
    ...
    /**
     * Gets the value of the videoobjectsAndAudioobjectsAndImageobjects property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the videoobjectsAndAudioobjectsAndImageobjects property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getVideoobjectsAndAudioobjectsAndImageobjects().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getVideoobjectsAndAudioobjectsAndImageobjects() {
        if (videoobjectsAndAudioobjectsAndImageobjects == null) {
            videoobjectsAndAudioobjectsAndImageobjects = new ArrayList<Object>();
        }
        return this.videoobjectsAndAudioobjectsAndImageobjects;
    }
