 ...
 *         &lt;element ref="{http://docbook.org/ns/docbook}refentrytitle"/>
 *         &lt;element ref="{http://docbook.org/ns/docbook}manvolnum" minOccurs="0"/>
 *         &lt;element ref="{http://docbook.org/ns/docbook}refmiscinfo" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://docbook.org/ns/docbook}indexterm" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    "indextermsAndRefentrytitlesAndManvolna"
})
@XmlRootElement(name = "refmeta")
public class Refmeta {

    @XmlElements({
        @XmlElement(name = "indexterm", required = true, type = Indexterm.class),
        @XmlElement(name = "refentrytitle", required = true, type = Refentrytitle.class),
        @XmlElement(name = "manvolnum", required = true, type = Manvolnum.class),
        @XmlElement(name = "refmiscinfo", required = true, type = Refmiscinfo.class)
    })
    protected List<Object> indextermsAndRefentrytitlesAndManvolna;
    ...
    /**
     * Gets the value of the indextermsAndRefentrytitlesAndManvolna property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the indextermsAndRefentrytitlesAndManvolna property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIndextermsAndRefentrytitlesAndManvolna().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getIndextermsAndRefentrytitlesAndManvolna() {
        if (indextermsAndRefentrytitlesAndManvolna == null) {
            indextermsAndRefentrytitlesAndManvolna = new ArrayList<Object>();
        }
        return this.indextermsAndRefentrytitlesAndManvolna;
    }
