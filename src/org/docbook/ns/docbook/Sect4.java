 ...
 *             &lt;choice minOccurs="0">
 *               &lt;sequence>
 *                 &lt;element ref="{http://docbook.org/ns/docbook}sect5" maxOccurs="unbounded"/>
...
public class Sect4 {
    ...
    @XmlElement(name = "sect5")
    protected List<Sect5> sect5S;
    ...
    /**
     * Gets the value of the sect5S property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sect5S property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSect5s().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Sect5> getSect5s() {
        if (sect5S == null) {
            sect5S = new ArrayList<Sect5>();
        }
        return this.sect5S;
    }
