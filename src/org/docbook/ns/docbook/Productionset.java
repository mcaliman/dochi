 ...
 *           &lt;element ref="{http://docbook.org/ns/docbook}production"/>
 *           &lt;element ref="{http://docbook.org/ns/docbook}productionrecap"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = {
    ...
    "info",
    "productionsAndProductionrecaps"
})
@XmlRootElement(name = "productionset")
public class Productionset {
    ...
    protected Info info;
    @XmlElements({
        @XmlElement(name = "production", type = Production.class),
        @XmlElement(name = "productionrecap", type = Productionrecap.class)
    })
    protected List<Object> productionsAndProductionrecaps;
    ...
    /**
     * Gets the value of the productionsAndProductionrecaps property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the productionsAndProductionrecaps property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProductionsAndProductionrecaps().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Production }
     * {@link Productionrecap }
     * 
     * 
     */
    public List<Object> getProductionsAndProductionrecaps() {
        if (productionsAndProductionrecaps == null) {
            productionsAndProductionrecaps = new ArrayList<Object>();
        }
        return this.productionsAndProductionrecaps;
    }
